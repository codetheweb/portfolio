		...
		<>
			...
			<div className={commonStyles.largerContainer}>
				<div className={commonStyles.textSection} style={{overflow: 'unset'}}>
					...
					<EmbeddedVideo ref={videoRef} macOSStyle autoPlay loop src="/videos/aoede/demo/discord.mp4" width={990} height={670}/>
					<EmbeddedVideo macOSStyle src="/videos/aoede/demo/spotify.mp4" syncWith={videoRef} width={990} height={672}/>
